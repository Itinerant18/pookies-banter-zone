...
<span className="text-4xl font-display font-bold bg-gradient-to-b from-cherry-200 to-cherry-600 text-transparent bg-clip-text animate-slide-down">Pookies Banter Zone</span>
        </Link>
