...
<h1 className="text-4xl font-display font-bold bg-gradient-to-r from-cherry-700 to-cherry-900 text-transparent bg-clip-text animate-slide-down">Pookie's Banter Zone</h1>
