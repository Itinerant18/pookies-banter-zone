...
<h1 className="text-4xl font-display font-bold bg-gradient-to-t from-cherry-100 to-cherry-500 text-transparent bg-clip-text animate-slide-down">Pookie's Banter Zone</h1>
